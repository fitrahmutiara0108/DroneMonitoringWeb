...
for (let i = 1; i <= num_rows; i++) {
  ...
  row.innerHTML = `
    ...
    <span class="table-text" style="color: rgba(234, 63, 11, 1)" id="column1-text">
      <a href="../admin/flight_detail.html" style="display: inline-block">FN-00000${i.toString().padStart(2, "0")}</a>
    </span>
    <span class="table-text" style="color: rgba(234, 63, 11, 1)" id="column2-text">
      <a href="../admin/drone_detail.html" style="display: inline-block">0908765432${i.toString().padStart(2, "0")}</a>
    </span>
